...
int main()
{
    ...
    for (int i = 0; i < my_input.size(); i++)
    {
        ...
        {
            // Diagonal case
            int k = my_input.at(i).at(1);

            if (((my_input.at(i).at(0) < my_input.at(i).at(2))) && ((my_input.at(i).at(1) < my_input.at(i).at(3))))
            {
                // x inc, y inc
                for (int j = my_input.at(i).at(0); j <= my_input.at(i).at(2); j++)
                {
            ...
            else if (((my_input.at(i).at(0) < my_input.at(i).at(2))) && ((my_input.at(i).at(1) > my_input.at(i).at(3))))
            {
                // x inc, y dec
                for (int j = my_input.at(i).at(0); j <= my_input.at(i).at(2); j++)
                {
